...
from merpcr.core.models import FASTARecord, STSHit, STSRecord, ThreadData
...
class TestSTSRecord(unittest.TestCase):
    ...
    def test_sts_record_defaults(self):
        ...
        sts = STSRecord(id="TEST002", primer1="GGCCTTAA", primer2="TTAAGGCC", pcr_size=200)
...
class TestFASTARecord(unittest.TestCase):
    ...
    def test_fasta_record_with_label(self):
        ...
        fasta = FASTARecord(defline=">seq1 Test sequence", sequence="ATCGATCGATCG", label="seq1")
    ...
    def test_fasta_record_auto_label(self):
        ...
        fasta = FASTARecord(
            defline=">chromosome1 Homo sapiens chromosome 1", sequence="AAAATTTTCCCCGGGG"
        )
    ...
    def test_fasta_record_no_arrow(self):
        ...
        fasta = FASTARecord(defline="seq_abc Description here", sequence="ATCG")
    ...
    def test_fasta_record_complex_defline(self):
        ...
        fasta = FASTARecord(
            defline=">gi|123456|gb|ABC123.1| Homo sapiens test sequence", sequence="GATTACA"
        )
...
class TestSTSHit(unittest.TestCase):
    ...
    def test_sts_hit_creation(self):
        ...
        sts = STSRecord(id="TEST001", primer1="ATCG", primer2="CGAT", pcr_size=100)
...
class TestThreadData(unittest.TestCase):
    ...
    def test_thread_data_creation(self):
        ...
        thread_data = ThreadData(thread_id=0, sequence="ATCGATCG", offset=1000, length=500)
    ...
    def test_thread_data_with_hits(self):
        ...
        thread_data = ThreadData(thread_id=1, sequence="ATCGATCG", offset=0, length=8, hits=[hit])
