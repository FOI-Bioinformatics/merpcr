...
TEST3\tGGGGAAAATTTT\tCCCCTTTTAAAA\t150"""
        ...
        large_sequence = ("ATCGATCGATCG" + "N" * 200 + "GCTAGCTAGCTA" + "N" * 1000 + 
                         "TACGTACGTACG" + "N" * 200 + "CGTACGTACGTA" + "N" * 1000 +
                         "GGGGAAAATTTT" + "N" * 200 + "CCCCTTTTAAAA") * 100  # ~350KB
...
TEST3\tGGGGAAAATTTT\tCCCCTTTTAAAA\t150"""
        ...
        sequence = ("ATCGATCGATCG" + "GCTAGCTAGCTA" + 
                   "TACGTACGTACG" + "CGTACGTACGTA" +
                   "GGGGAAAATTTT" + "CCCCTTTTAAAA") * 1000  # Large sequence
